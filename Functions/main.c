...
/* Examples HowTo implement functions in C
*  K. Herman
*/
#include <stdio.h>
...
int main()
{
    ...
    /* no argument no returned data */
    foo();
    /* two arguments passed by value and the result returned by the function */
    area = Area(a,b);
...
* more precisely by a pointer to the argument what results
